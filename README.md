...
For the APTOS and FGADR datasets, they are utilized to do OOD test. Please train a model on the DDR dataset, then do the OOD test on these two datasets.
